...
/**
 * This is the Line Action class that is used to link
 * the line tool to the button on the tool bar and
 * on the menu.
 * @author Daniel Henderson (dhende32@u.washington.edu)
 * @version Spring 2012
 */
@SuppressWarnings("serial")
public class PowerPaintLineDraw extends AbstractAction
{
  /**
   * Constructor used to create the Line Action Object. It calls to its super class
   ...
   */
  public PowerPaintLineDraw(final String the_text, final ImageIcon the_icon,
  ...
  {
    PowerPaintGui.setSelectedTool("Line");
