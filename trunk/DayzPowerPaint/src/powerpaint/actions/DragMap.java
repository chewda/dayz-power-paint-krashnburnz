...
public class DragMap extends AbstractAction{
	  /**
	 * 
	 */
	...
	/**
	   * Constructor used to create the Dragmap Action Object. It calls to its super class
	   ...
	   */
	  public DragMap(final String the_text, final ImageIcon the_icon,
	  ...
	  {
	    PowerPaintGui.setSelectedTool("Drag");
