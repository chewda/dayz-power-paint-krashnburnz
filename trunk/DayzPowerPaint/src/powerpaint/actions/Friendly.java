...
public class Friendly extends AbstractAction{
	...
	/**
	   * Constructor used to create the Friendly Action Object. It calls to its super class
	   ...
	   */
	  public Friendly(final String the_text, final ImageIcon the_icon,
	  ...
	  {
	    PowerPaintGui.setSelectedTool("Friendly");
