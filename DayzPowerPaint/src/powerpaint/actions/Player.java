...
public class Player extends AbstractAction{
	...
	/**
	   * Constructor used to create the DayzGuy Action Object. It calls to its super class
	   ...
	   */
	  public Player(final String the_text, final ImageIcon the_icon,
	  ...
	  {
	    PowerPaintGui.setSelectedTool("Player");
