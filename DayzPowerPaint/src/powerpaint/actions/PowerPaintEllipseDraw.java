...
/**
 * This is the Ellipse Action class that is used to link
 * the Ellipse tool to the button on the tool bar and
 * on the menu.
 * @author Daniel Henderson (dhende32@u.washington.edu)
 * @version Spring 2012
 */
@SuppressWarnings("serial")
public class PowerPaintEllipseDraw extends AbstractAction
{
  /**
   * Constructor used to create the Ellipse Action Object. It calls to its super class
   * passing in the text "Color" and the Icon chosen for the ellipse button.
   ...
   */
  public PowerPaintEllipseDraw(final String the_text, final ImageIcon the_icon,
  ...
  {
    PowerPaintGui.setSelectedTool("Ellipse");
