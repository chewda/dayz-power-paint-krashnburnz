...
public class Enemy extends AbstractAction{
	  /**
	 * 
	 */
	...
	/**
	   * Constructor used to create the Enemy Action Object. It calls to its super class
	   ...
	   */
	  public Enemy(final String the_text, final ImageIcon the_icon,
	  ...
	  {
	    PowerPaintGui.setSelectedTool("Enemy");
